    ...
    public static class ProductSeeder
    {
        public static async Task SeedAsync(ApplicationDbContext db)
        {
            ...
            [
                ...
                new()
                {
                    Name = "Баскетболна Топка Spalding",
                ...
                new()
                {
                    Name = "Боксови ръкавици Everlast",
